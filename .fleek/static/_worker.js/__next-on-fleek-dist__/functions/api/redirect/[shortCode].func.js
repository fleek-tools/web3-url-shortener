...
var stdin_default = ((self, globalThis2, global) => {
  ...
  (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[295], { 2067: __chunk_2067, 26195: __chunk_26195, 93805: (t, e, r) => {
    ...
    async function aj(t10) {
      let { searchParams: e10 } = new URL(t10.url), r10 = e10.get("shortCode");
      if ("GET" !== t10.method)
        return new Response(JSON.stringify({ error: "Method not allowed" }), { status: 405, headers: { "Content-Type": "application/json" } });
      try {
        let t11 = new aH("https://arb-sepolia.g.alchemy.com/v2/NiaoOlWmEe3y5sU3a3c4artPHYXj2xYq"), e11 = new nO("0x2729D62B3cde6fd2263dF5e3c6509F87C6C05892", aQ.M, t11), n10 = await e11.getURL(r10);
        if (n10 && "" !== n10) {
          let t12 = n10.startsWith("http") ? n10 : `https://${n10}`;
          return new Response(JSON.stringify({ url: t12 }), { status: 200, headers: { "Content-Type": "application/json" } });
        }
        return new Response(JSON.stringify({ error: "URL not found" }), { status: 404, headers: { "Content-Type": "application/json" } });
      } catch (t11) {
        return console.error("Error:", t11), new Response(JSON.stringify({ error: "Server error" }), { status: 500, headers: { "Content-Type": "application/json" } });
      }
    }
    function aV(t10) {
